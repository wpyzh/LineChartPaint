...
//                                              ,"68", "88", "86", "70", "65","84","88"};
    ...
    private String[] xAisxValue = new String[]{"2019-06-11 23:25:00","2019-06-11 23:30:00"};
    private String[] yAisxValue = new String[]{"90", "80"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            iBreathDayLineChart.setChartData(xAisxs,yAisx1,xAisxValue,yAisxValue,xAisxs[0],xAisxs[xAisxs.length-1]);
